...
clf %clears figure
set(fig,'Position',[150,fig.Position(2),1200,700]); %sets the position and dimensions
...
logo_txt = text(125,210,'BATTLESHIP','FontSize',50,'color','white','FontWeight','bold'); %plots title
axis off
letter = 'a:h';
number = 1:8;
...
%https://www.pexels.com/photo/blue-water-2860705/